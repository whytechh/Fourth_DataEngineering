...
def load_text():
    with open(r'lab_4\task_1_solve_result\item.text', 'r', encoding='utf-8') as file:
...
save_items(r'lab_4\task_1_solve_result\task_1_sorted_prob_price.json', first_query(db))
save_items(r'lab_4\task_1_solve_result\task_1_stats_views.json', second_query(db))
save_items(r'lab_4\task_1_solve_result\task_1_freq_city.json', third_query(db))
save_items(r'lab_4\task_1_solve_result\task_1_year_filtered.json', fourth_query(db))
