...
def read_json():
    with open(r'lab_4\task_2_solve_result\subitem.json', 'r', encoding='utf-8') as file:
...
save_items(r'lab_4\task_2_solve_result\task_2_query_1.json', first_query(db))
save_items(r'lab_4\task_2_solve_result\task_2_query_2.json', second_query(db))
save_items(r'lab_4\task_2_solve_result\task_2_query_3.json', third_query(db))
